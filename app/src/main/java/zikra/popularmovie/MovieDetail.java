...
import zikra.popularmovie.adapter.ReviewAdapter;
import zikra.popularmovie.adapter.TrailerAdapter;
import zikra.popularmovie.provider.MovieContract;
import zikra.popularmovie.data.MovieData;
import zikra.popularmovie.provider.MovieDbHelper;
import zikra.popularmovie.data.ReviewData;
import zikra.popularmovie.data.TrailerData;
import zikra.popularmovie.helper.MyFunction;
